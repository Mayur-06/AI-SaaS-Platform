...
from common.core.views import AdminHealthView, AdminUsageView, AdminTenantsView, AdminRoutingView
...
urlpatterns = [
    ...
    path("routing/", AdminRoutingView.as_view(), name="admin-routing"),
]
